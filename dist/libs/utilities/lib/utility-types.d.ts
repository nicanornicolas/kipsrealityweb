...
export declare enum UtilityBillStatus {
    DRAFT = "DRAFT",
...
export declare enum UtilitySplitMethod {
    EQUAL = "EQUAL",
...
export declare enum UtilityImportMethod {
    CSV = "CSV",
    API = "API",
    PDF_OCR = "PDF_OCR",
...
export declare enum CreateBillError {
...
export declare enum ReadingError {
...
export declare enum AllocateError {
...
export declare enum TransitionError {
    BILL_NOT_FOUND = "BILL_NOT_FOUND",
    INVALID_STATUS = "INVALID_STATUS",
    BILL_ALREADY_POSTED = "BILL_ALREADY_POSTED"
}
/** Errors during bill approval */
export declare enum ApproveError {
    BILL_NOT_FOUND = "BILL_NOT_FOUND",
    INVALID_STATUS = "INVALID_STATUS",
...
export type AllocationMethod = "RUBS_OCCUPANCY" | "SQUARE_FOOTAGE" | "EQUAL_SPLIT" | "AI_SUGGESTED";
