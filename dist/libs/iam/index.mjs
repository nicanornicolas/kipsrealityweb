...
In case this error is unexpected for you, please report it in https://pris.ly/prisma-prisma-bug-report`);
		...
		DbNull: s.DbNull,
		JsonNull: s.JsonNull
	}, e.Prisma.JsonNullValueInput = { JsonNull: s.JsonNull }, e.Prisma.NullsOrder = {
		first: "first",
		last: "last"
...
var nt = /* @__PURE__ */ s(((e) => {
	...
	var t = nt(), n = lt(), r = ut(), i = pt(), a = /^(?:127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|\[::1\]|localhost)$/;
	function o(e, t) {
  ...
  `);
	...
	var n = mt(), r = gt(), i = _t(), a = yt(), o = Symbol("internal request"), s = class extends Request {
		constructor(e, t = {}) {
	...
	var t = yt(), n = mt(), r = gt(), i = xt(), a = yt(), o = Symbol("internal response"), s = new Set([
		301,
		302,
		303,
		307,
	...
	var t = (0, Dt().createAsyncLocalStorage)();
})), kt = /* @__PURE__ */ s(((e) => {
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), t(At(), e);
	function t(e, t) {
	...
	var n = Pt(), r = Ft(), i = /* @__PURE__ */ function(e) {
	...
	var n = /* @__PURE__ */ m(u("react")), r = Rt(), i = zt(), a = Lt(), o = kt(), s = Bt(), c = Vt(), l = Ht(), d = Ut(), f = Pt(), p = Wt();
	function m(e) {
		return e && e.__esModule ? e : { default: e };
	}
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`);
	...
	var t = kt(), n = Lt(), r = Gt(), i = zt(), a = Bt(), o = Jt(), s = It(), c = Pt();
	function l() {
	...
	var n = {
		NextRequest: bt().NextRequest,
		NextResponse: St().NextResponse,
		ImageResponse: Ct().ImageResponse,
		userAgentFromString: Tt().userAgentFromString,
		userAgent: Tt().userAgent,
		URLPattern: Et().URLPattern,
		after: jt().after,
		connection: Yt().connection
	};
	...
	var n = yt(), r = xt(), i = kt(), a = Zt(), o = class e extends Error {
		constructor() {
	...
	var t = Qt(), n = yt(), r = kt(), i = Lt(), a = Gt(), o = zt(), s = Bt(), c = $t(), l = Jt(), u = Pt(), d = It();
	function f() {
	...
	var n = xt(), r = class e extends Error {
		constructor() {
	...
	var t = tn(), n = kt(), r = Lt(), i = Gt(), a = zt(), o = Bt(), s = $t(), c = Jt(), l = Pt(), u = It();
	function d() {
	...
	var t = Lt(), n = kt(), r = Gt(), i = $t(), a = zt(), o = Rt(), s = Pt(), c = Bt(), l = xt();
	function u() {
	...
	t.exports.cookies = en().cookies, t.exports.headers = nn().headers, t.exports.draftMode = rn().draftMode;
})), on = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__, sn = globalThis, cn = "10.47.0";
//#endregion
...
function un(e) {
	...
	return t.version = t.version || "10.47.0", t[cn] = t["10.47.0"] || {};
}
function dn(e, t, n = sn) {
	let r = n.__SENTRY__ = n.__SENTRY__ || {}, i = r[cn] = r["10.47.0"] || {};
	return i[e] || (i[e] = t());
}
//#endregion
//#region ../../node_modules/@sentry/core/build/esm/utils/debug-logger.js
var fn = "Sentry Logger ", pn = {};
function mn(e) {
	if (!("console" in sn)) return e();
	let t = sn.console, n = {}, r = Object.keys(pn);
	r.forEach((e) => {
		let r = pn[e];
		n[e] = t[e], t[e] = r;
	});
...
function Sn() {
	return on ? dn("loggerSettings", () => ({ enabled: !1 })) : { enabled: !1 };
}
var Cn = {
	enable: hn,
	disable: gn,
...
function On(e, t, n) {
	try {
		...
		on && Cn.log(`Failed to add non-enumerable property "${t}" to object`, e);
	}
}
//#endregion
...
var kn;
function An(e) {
	if (kn !== void 0) return kn ? kn(e) : e();
	let t = Symbol.for("__SENTRY_SAFE_RANDOM_ID_WRAPPER__"), n = sn;
	return t in n && typeof n[t] == "function" ? (kn = n[t], kn(e)) : (kn = null, e());
}
function jn() {
	return An(() => Math.random());
}
function Mn() {
	return An(() => Date.now());
}
...
function Ln(e = Pn()) {
	try {
		if (e?.randomUUID) return An(() => e.randomUUID()).replace(/-/g, "");
	} catch {}
	return Fn ||= "10000000100040008000100000000000", Fn.replace(/[018]/g, (e) => (e ^ (In() & 15) >> e / 4).toString(16));
}
//#endregion
...
function Bn() {
	let { performance: e } = sn;
	if (!e?.now || !e.timeOrigin) return zn;
	let t = e.timeOrigin;
	return () => (t + An(() => e.now())) / Rn;
}
var Vn;
function Hn() {
	return (Vn ??= Bn())();
...
function Un(e, t = {}) {
	if (t.user && (!e.ipAddress && t.user.ip_address && (e.ipAddress = t.user.ip_address), !e.did && !t.did && (e.did = t.user.id || t.user.email || t.user.username)), e.timestamp = t.timestamp || Hn(), t.abnormal_mechanism && (e.abnormal_mechanism = t.abnormal_mechanism), t.ignoreDuration && (e.ignoreDuration = t.ignoreDuration), t.sid && (e.sid = t.sid.length === 32 ? t.sid : Ln()), t.init !== void 0 && (e.init = t.init), !e.did && t.did && (e.did = `${t.did}`), typeof t.started == "number" && (e.started = t.started), e.ignoreDuration) e.duration = void 0;
...
function Wn(e, t, n = 2) {
	...
	let r = { ...e };
	for (let e in t) Object.prototype.hasOwnProperty.call(t, e) && (r[e] = Wn(r[e], t[e], n - 1));
	return r;
}
//#endregion
...
var Yn = 100, Xn = class e {
	...
	clone() {
		let t = new e();
		return t._breadcrumbs = [...this._breadcrumbs], t._tags = { ...this._tags }, t._attributes = { ...this._attributes }, t._extra = { ...this._extra }, t._contexts = { ...this._contexts }, this._contexts.flags && (t._contexts.flags = { values: [...this._contexts.flags.values] }), t._user = this._user, t._level = this._level, t._session = this._session, t._transactionName = this._transactionName, t._fingerprint = this._fingerprint, t._eventProcessors = [...this._eventProcessors], t._attachments = [...this._attachments], t._sdkProcessingMetadata = { ...this._sdkProcessingMetadata }, t._propagationContext = { ...this._propagationContext }, t._client = this._client, t._lastEventId = this._lastEventId, t._conversationId = this._conversationId, qn(t, Jn(this)), t;
	}
	setClient(e) {
		this._client = e;
	}
	...
	setUser(e) {
		return this._user = e || {
			...
			ip_address: void 0,
			username: void 0
		}, this._session && Un(this._session, { user: e }), this._notifyScopeListeners(), this;
	}
	getUser() {
		return this._user;
	}
	...
	update(t) {
		if (!t) return this;
		let n = typeof t == "function" ? t(this) : t, { tags: r, attributes: i, extra: a, user: o, contexts: s, level: c, fingerprint: l = [], propagationContext: u, conversationId: d } = (n instanceof e ? n.getScopeData() : En(n) ? t : void 0) || {};
		return this._tags = {
			...this._tags,
			...r
		}, this._attributes = {
	...
	addBreadcrumb(e, t) {
		let n = typeof t == "number" ? t : Yn;
		if (n <= 0) return this;
		let r = {
			timestamp: zn(),
			...e,
			message: e.message ? Nn(e.message, 2048) : e.message
		};
	...
	setSDKProcessingMetadata(e) {
		return this._sdkProcessingMetadata = Wn(this._sdkProcessingMetadata, e, 2), this;
	}
	...
	captureException(e, t) {
		let n = t?.event_id || Ln();
		if (!this._client) return on && Cn.warn("No client configured on scope - will not capture exception!"), n;
	...
	captureMessage(e, t, n) {
		let r = n?.event_id || Ln();
		if (!this._client) return on && Cn.warn("No client configured on scope - will not capture message!"), r;
	...
	captureEvent(e, t) {
		let n = e.event_id || t?.event_id || Ln();
		return this._client ? (this._client.captureEvent(e, {
			...t,
			event_id: n
		}, this), n) : (on && Cn.warn("No client configured on scope - will not capture event!"), n);
	}
...
function Zn() {
	return dn("defaultCurrentScope", () => new Xn());
}
function Qn() {
	return dn("defaultIsolationScope", () => new Xn());
}
//#endregion
//#region ../../node_modules/@sentry/core/build/esm/utils/chain-and-copy-promiselike.js
var $n = (e) => e instanceof Promise && !e[er], er = Symbol("chained PromiseLike"), tr = (e, t, n) => {
	let r = e.then((e) => (t(e), e), (e) => {
		throw n(e), e;
	});
	return $n(r) && $n(e) ? r : nr(e, r);
}, nr = (e, t) => {
	let n = !1;
	for (let r in e) {
		if (r in t) continue;
	...
	return n && Object.assign(t, { [er]: !0 }), t;
}, rr = class {
	constructor(e, t) {
		let n;
		n = e || new Xn();
		let r;
		r = t || new Xn(), this._stack = [{ scope: n }], this._isolationScope = r;
	}
	withScope(e) {
		...
		return Dn(n) ? tr(n, () => this._popScope(), () => this._popScope()) : (this._popScope(), n);
	}
	getClient() {
...
function ir() {
	let e = un(ln());
	return e.stack = e.stack || new rr(Zn(), Qn());
}
function ar(e) {
	return ir().withScope(e);
}
function or(e, t) {
	let n = ir();
...
function sr(e) {
	return ir().withScope(() => e(ir().getIsolationScope()));
}
function cr() {
	return {
...
async function gr() {
	try {
		let e = (await (0, hr.cookies)()).get("token")?.value;
		return e ? Je(e) : null;
	} catch {
		return null;
	}
...
async function _r(e, t) {
	let n = await gr();
	if (!n) return mr.NextResponse.json({ error: "Unauthorized - No valid token" }, { status: 401 });
	if (pr({
		id: n.userId,
		email: n.email
	}), fr("auth.role", n.role), fr("org.id", n.organizationId), fr("org.userId", n.organizationUserId), dr("organization", {
		id: n.organizationId,
		...
		let e = new URL(t.url);
		fr("http.method", t.method), fr("http.route", e.pathname);
	} catch {}
	return !n.role || !e.includes(n.role) ? mr.NextResponse.json({ error: `Forbidden - Requires one of: ${e.join(", ")}` }, { status: 403 }) : null;
}
async function vr(e) {
...
async function xr(e) {
	try {
		...
		if (t ||= (await (0, hr.cookies)()).get("token")?.value || null, !t) return null;
		let n = Je(t);
		return {
			id: n.userId,
			email: n.email,
...
//#endregion
var Sr = h.PrismaClient;
export { f as Iam, Sr as PrismaClient, Ze as auth, Xe as authOptions, et as createOtp, v as db, Ke as generateAccessToken, $e as generateOtpCode, qe as generateRefreshToken, xr as getCurrentUser, br as getCurrentUserRole, Ge as getJwtRefreshSecret, We as getJwtSecret, _ as prisma, yr as requireAdminRole, _r as requireRole, vr as requireSystemAdmin, Je as verifyAccessToken, tt as verifyOtp, Ye as verifyRefreshToken };
