...
export declare enum BulkListingActionType {
    LIST = "LIST",
    UNLIST = "UNLIST",
    SUSPEND = "SUSPEND",
    MAINTENANCE_START = "MAINTENANCE_START",
...
export declare enum CreateListingError {
...
export declare enum RemoveListingError {
...
export declare enum UpdateStatusError {
    LISTING_NOT_FOUND = "LISTING_NOT_FOUND",
...
export declare enum BulkOperationError {
...
export type BulkUpdateResult = Result<BulkResult, BulkOperationError>;
/** Result of getListingHistory() */
export type ListingHistoryResult = Result<ListingAuditEntry[], "UNIT_NOT_FOUND" | "PERMISSION_DENIED">;
/** Valid state transitions for listing status */
export declare const VALID_STATUS_TRANSITIONS: Record<ListingStatus, ListingStatus[]>;
/** Helper function to validate status transitions */
export declare function isValidStatusTransition(from: ListingStatus, to: ListingStatus): boolean;
