...
CREATE TABLE `utility_allocations` (
    ...
    `tenant_id` VARCHAR(191) NULL,
    `lease_id` VARCHAR(191) NULL,
    `splitMethod` ENUM('EQUAL', 'OCCUPANCY_BASED', 'SQ_FOOTAGE', 'SUB_METERED', 'CUSTOM_RATIO', 'AI_OPTIMIZED', 'FIXED') NOT NULL DEFAULT 'EQUAL',
...
CREATE TABLE `invoice` (
    ...
    `status` ENUM('DRAFT', 'PENDING', 'PAID', 'OVERDUE', 'CANCELLED') NULL DEFAULT 'PENDING',
