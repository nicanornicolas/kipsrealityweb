...
import { UtilityBillStatus } from '@rentflow/utilities/client';
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-52">
          <DropdownMenuLabel className="text-xs text-slate-500 uppercase tracking-wider font-normal">
            Actions
          </DropdownMenuLabel>
          <DropdownMenuSeparator />
      ...
      <AlertDialog open={showPostDialog} onOpenChange={setShowPostDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This creates a permanent journal entry. Status will change to{' '}
              <span className="font-semibold text-purple-600">POSTED</span>.
              <br />
              <br />
              <span className="text-amber-600 bg-amber-50 p-1 rounded text-xs font-semibold uppercase">
                Caution
              </span>{' '}
