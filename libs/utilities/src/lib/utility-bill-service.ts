...
type TransitionResult = Result<{ status: UtilityBillStatus }, TransitionError>;
    ...
    return tx.utilityBill.create({
      data: {
        ...
        importMethod: (importMethod ??
          'MANUAL_ENTRY') as PrismaUtilityImportMethod,
...
export async function getAllocationsForBillFromBillService(
  billId: string,
