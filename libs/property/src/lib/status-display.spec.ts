...
describe('Status Display Consistency Property Tests', () => {
  it.skip('Property 2: Status Display Consistency - Status Indicator Mapping', async () => {
    await fc.assert(
      fc.property(mockUnitWithListingGenerator, (unit) => {
  ...
  it.skip('Property 2: Status Display Consistency - Available Actions Logic', async () => {
    await fc.assert(
      fc.property(listingStatusGenerator, (status) => {
          ...
          [ListingStatus.ACTIVE]: [
            {
              ...
              targetStatus: ListingStatus.PRIVATE,
            },
  ...
  it.skip('Property 2: Status Display Consistency - Status Transition Validity', async () => {
    await fc.assert(
      fc.property(
  ...
  it.skip('Property 2: Status Display Consistency - Unit Data Display', async () => {
    await fc.assert(
      fc.property(mockUnitWithListingGenerator, (unit) => {
  ...
  it('Property 2: Status Display Consistency - Listing Details Visibility', async () => {
    await fc.assert(
      fc.property(mockUnitWithListingGenerator, (unit) => {
  ...
  it.skip('Property 2: Status Display Consistency - Color and Icon Consistency', async () => {
    await fc.assert(
      fc.property(listingStatusGenerator, (status) => {
  ...
  it('Property 2: Status Display Consistency - Action Button States', async () => {
    await fc.assert(
      fc.property(
  ...
  it('Property 2: Status Display Consistency - Error State Handling', async () => {
    await fc.assert(
      fc.property(
        mockUnitWithListingGenerator,
  ...
  it('Property 2: Status Display Consistency - Performance Metrics Display', async () => {
    await fc.assert(
      fc.property(
        mockUnitWithListingGenerator,
        ...
        (unit, showMetrics) => {
          ...
          const shouldShowMetrics =
            showMetrics && hasActiveListing && unit.listing;
