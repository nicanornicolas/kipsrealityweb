...
const titleGenerator = fc.option(fc.string({ minLength: 1, maxLength: 200 }), {
  nil: undefined,
});
const descriptionGenerator = fc.option(
...
const mockUnitGenerator = fc.record({
  ...
  property: fc.record({
    ...
    amenities: fc.option(fc.string({ minLength: 1, maxLength: 500 }), {
      nil: undefined,
    }),
  }),
...
describe('Listing Creation Completeness Property Tests', () => {
  it('Property 4: Complete Listing Creation - Required fields are populated', async () => {
    await fc.assert(
      fc.property(
        ...
        (listingData, mockUnit, userId) => {
          ...
          const expectedTitle =
            listingData.title ||
            `${mockUnit.property.name || 'Unit'} ${mockUnit.unitNumber}`;
  ...
  it('Property 4: Complete Listing Creation - Default value population logic', async () => {
    await fc.assert(
      fc.property(mockUnitGenerator, (mockUnit) => {
  ...
  it('Property 4: Complete Listing Creation - Status consistency', async () => {
    await fc.assert(
      fc.property(
        createListingDataGenerator,
        mockUnitGenerator,
  ...
  it('Property 4: Complete Listing Creation - Field validation rules', async () => {
    await fc.assert(
      fc.property(createListingDataGenerator, (listingData) => {
  ...
  it('Property 4: Complete Listing Creation - Error conditions', () => {
  ...
  it('Property 4: Complete Listing Creation - Marketplace data structure', async () => {
    await fc.assert(
      fc.property(mockUnitGenerator, (mockUnit) => {
